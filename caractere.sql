...
--
-- Base de données : `caractere`
--
CREATE DATABASE IF NOT EXISTS `caractere` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `caractere`;
