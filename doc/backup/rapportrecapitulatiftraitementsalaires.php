...
?>
	...
	<!-- 
	 ...
	 <page_footer>
		...
		<table>
			<tr>
				...
				<td style="width: 70%; text-align: center; padding-top: 10px;">
					<span style='font-size: 20px; text-align: center; vertical-align:middle;'>ETAT DES SOMMES VERSEES EN </span><br>
					<span style='font-size: 20px;'>SOUS LA FORME DE :</span><br>
					<span style='font-size: 10px;'>
						Traitements, salsires, r&eacute;tributions, pensions et rentes viag&egrave;re. A fournir par <br>
						localit&eacute; pour les entreprises (1) &agrave; succursales ou &eacute;tablissements (2) multiples et &agrave; <br>

						transmettre au service des imp&ocirc;ts
					</span><br>
				</td>
				<td style="width: 9%; text-align: left; padding-top: 1px;">
					<div style='font-size: 20px; text-align: center; border: 1px solid #000;'>2019</div>
				</td>
			</tr>
		</table>
		<br>
		<table style="width: 25%; margin-top: -30px;">
			<tr>
		...
		<table style="width: 75%; margin-left: 250px; margin-top: -120px;">
			<tr>
					...
					<table style="" border="1" cellspacing='0' cellpadding='0'>
						<tr style="">
							<td style="padding: 10px; padding-right: 40px; padding-left: 40px;">
								Le 31 Janvier (d&eacute;lais de rigueur) de chaque ann&eacute;e
							</td>
						</tr>
					</table>
				</td>
		...
		<table style="width: 15%; margin-top: 50px;">
			<tr>
				<td style="text-align: center; width: 100%; padding-top: 30px;">
					<table style="" border="1" cellspacing='0' cellpadding='0'>
						<tr style="">
							<td style="padding: 10px; padding-top: 40px; padding-bottom: 40px;">
								TIMBRE A DATE
							</td>
						</tr>
					</table>
		...
		<table style="margin-top: -120px; margin-left: 130px; width: 85%; border-top: 2px solid #000; border-left: 2px solid #000;">
			<tr>
				<td style="width: 100%;">
					...
					<table>
						...
						<tr>
							<td>
								<span style='font-size: 12px;'>In extenso : <strong>Jean-Pierre PAMBOU</strong> <?php ?></span>
							</td>
						</tr>
					</table>
					<table>
		...
		<table style="margin-left: 130px; width: 85%; border-top: 2px solid #000; border-left: : 2px solid #000;">
			<tr>
				<td style="width: 50%;">
					<div>
						<span>EFFECTIF SENEGALAIS</span> &nbsp;&nbsp;&nbsp;
						<span style="float: right;">H:44 F:31</span>
					</div>
				</td>
				<td style="width: 50%;">
					<div>
						<span>EFFECTIF ETRANGER</span> &nbsp;&nbsp;&nbsp;
						<span style="float: right;">H:0 F:8</span>
					</div>
				</td>
			</tr>
			<tr>
		...
		<table style="margin-left: 130px; width: 85%; border-top: 2px solid #000; border-left: : 2px solid #000;">
			<tr>
				<td style="width: 30%; border-right: 2px solid #000;">
						<span>Salaires vers&eacute;s</span><br>
						<span>Total ann&eacute;e :</span>
						<span style="float: right;">299 254 123</span>
				</td>
				<td style="width: 15%; text-align: center; border-right: 2px solid #000;">
						<span>S&eacute;n&eacute;galais</span> <br><br>
						<span style="float: right;">Etrangers</span>
				</td>
				<td style="width: 15%; text-align: center; border-right: 2px solid #000;">
						<span>45</span> <br><br>
						<span>4</span>
				...
				<td style="width: 20%; border-right: 2px solid #000;">
						<span>Commission Honoraires</span> <br>
						<span>(ART.185 C.G.I)</span> <br>
						<span style="font-size: 10px;">Total ann&eacute;e</span>
				</td>
				<td style="width: 20%; text-align: center;">
						<span>&nbsp;</span> <br>
						<span>45 256 233</span> <br>
						<span>&nbsp;</span>
				</td>
			</tr>
		</table>

		<table style="margin-left: 130px; width: 85%; border-top: 2px solid #000; border-left: : 2px solid #000; border-bottom: : 2px solid #000;">
			<tr>
				<td style="width: 30%;">
						<span>&nbsp;</span><br>
						<span>CFCE Vers&eacute;es : </span>
						<span>&nbsp;</span>
				</td>
		...
		<table border="0.5" cellspacing='0' cellpadding='0' style="margin-top: 10px;">
			<tr style="">
				<th style="width:50%; padding-top: 8px; padding-bottom: 8px; padding-left: 5px; text-align: center; font-size: 10px;">DESIGNATION DES PERSONNES RETRIBUEES</th>
				<th style="width:25%; padding-top: 8px; padding-bottom: 8px; padding-left: 5px; text-align: center; font-size: 10px;">RETRIBUTIONS</th>
				<th style="width:25%; padding-top: 8px; padding-bottom: 8px; padding-left: 5px; text-align: center; font-size: 10px;"></th>
			</tr>
		</table>
		<table border="0.5" cellspacing='0' cellpadding='0' style="border-top: 0px; display: inline-block;">
			<tr>
				<td style="width:20%; font-size: 10px; text-align: center;">
					Pr&eacute;noms et Noms pr&eacute;c&eacute;d&eacute;s de la metion<br>
					- M pour Monsieur <br>
					- Mme pour Madame <br>
					- Mlle pour Mademoiselle  <br>

				</td>
				<td style="width:10%; font-size: 10px; text-align: center;">Qualit&eacute;</td>
				<td style="width:20%; font-size: 10px; text-align: center;">Adresse au 1<sup>er</sup> Janvier <strong>2018</strong></td>
				<td style="width:12.5%; font-size: 10px; text-align: center;">
					Nature
				</td>
				<td style="width:12.5%; font-size: 10px; text-align: center;">Montant</td>
				<td style="width:25%; font-size: 10px; text-align: center;">
					Num&eacute;ro de compte contribuable des b&eacute;n&eacute;ficiaires
				</td>
			</tr>
		</table>
		...
		<table cellspacing='0' cellpadding='0'>
			<tr style="">
				<td style="width:62.5%; padding-top: 8px; padding-bottom: 8px; padding-left: 5px; text-align: right;">TOTAL GENERAL OU A REPORTER</td>
				<th style="width:12.5%; padding-top: 8px; padding-bottom: 8px; padding-left: 5px; border:1px solid #000"></th>
			</tr>
		</table>
