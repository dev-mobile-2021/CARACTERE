...
if (isset($_GET['idDevis'])) {
	...
	$requeteRubrique = Connexion::Connect()->query("
						SELECT r.idRubrique, r.rubrique, (SELECT SUM(somme) FROM vrubrique WHERE idRubrique = r.idRubrique AND idDevis = \"$idDevis\") as total , (SELECT SUM(sommeAchat) FROM vrubrique WHERE idRubrique = r.idRubrique AND idDevis = \"$idDevis\") as totalAchat 
						FROM rubrique r 
		...
		<table style="width: 100%;margin-right: 0px ">
			<tr>
				<td style="width: 100%;margin-right: 0px">
					<img style="width: 80%;height: 10%;margin-right: 0px;" src="img/piedpage.png">
				</td>
			</tr>
		</table>
	</page_footer>
	<?php foreach ($list as $value) { 
		$typetaxe =$value['idTypetaxe'];

		?>
		<table style="width: 100%;" class="addPadding">
			<tr>
		...
		<table class="addPadding">
			<tr>
				<td style="width: 100%; text-align: center; font-weight: bold;">FEUILLE DE MARGE</td>
			</tr>
		</table>
		<br>
		<table class="addPadding">
		...
		<?php $i = 0;
			...
			<table class="addPadding" cellpadding="0" cellspacing="0">
				...
				<tr style="">
					<td style="background-color: #26c0c9; color: #ffffff; padding: 5px; padding-top: 1px; padding-bottom: 1px; width: 51%; font-weight: bold;"><?php echo html_entity_decode(decodeCaractere($valueRubrique['rubrique'])) ?></td>
					<td style="background-color: #26c0c9; color: #ffffff; padding: 5px; padding-top: 1px; padding-bottom: 1px; width: 9%; text-align: right;"><?php echo number_format($valueRubrique['total'], 0, ',', ' ') ?> F</td>

					<td style="padding: 5px; padding-top: 1px; padding-bottom: 1px; width: 8.8%; font-weight: bold; text-align: center;"><?php echo number_format($valueRubrique['totalAchat'], 0, ',', ' ') ?> F</td>
					<td style="padding: 5px; padding-top: 1px; padding-bottom: 1px; width: 8.8%; text-align: center;"><?php echo number_format($valueRubrique['total'] - $valueRubrique['totalAchat'], 0, ',', ' ') ?> F </td>
					<td style="padding: 5px; padding-top: 1px; padding-bottom: 1px; width: 8%; text-align: center;"><?php echo round((($valueRubrique['total'] - $valueRubrique['totalAchat']) / $valueRubrique['total']) * 100) ?> %</td>
					<td style="padding: 5px; padding-top: 1px; padding-bottom: 1px; width: 14.4%; text-align: center;"> </td>
				</tr>
			</table>
			<?php
			...
			<?php foreach ($listFamille as $valueFamille) { ?>
				<table class="addPadding" cellpadding="0" cellspacing="0" style="margin-top: 5px;">
					<!-- <tr style="background-color: #a1cbe6; color: #ffffff;">
						<td style="padding: 5px; padding-top: 1px; padding-bottom: 1px; width: 60%; font-weight: bold;"><?php echo html_entity_decode(decodeCaractere($valueFamille['famille'])) ?></td>
					</tr> -->
				</table>
				<?php
							$idRubrique = $valueRubrique['idRubrique'];
				...
				<?php foreach ($listTypeservice as $valueTypeservice) {
					...
					<table class="addPadding" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td style="padding: 5px; padding-top: 1px; padding-bottom: 1px; width: 51%; font-weight: bold;"><?php echo html_entity_decode(decodeCaractere($valueFamille['famille'])) ?></td>

							<td style="padding: 5px; padding-top: 1px; padding-bottom: 1px; width: 9%; text-align: right; font-weight: bold;">
								<?php echo number_format($valueTypeservice['somme'], 0, ',', ' ') ?> F
							</td>
							<td style="padding: 5px; padding-top: 1px; padding-bottom: 1px; width: 8.8%; font-weight: bold; text-align: center;"><?php echo number_format($valueTypeservice['sommeAchat'], 0, ',', ' ') ?> F</td>
							<td style="padding: 5px; padding-top: 1px; padding-bottom: 1px; width: 8.8%; text-align: center;"><?php echo number_format($valueTypeservice['somme'] - $valueTypeservice['sommeAchat'], 0, ',', ' ') ?> F </td>
							<td style="padding: 5px; padding-top: 1px; padding-bottom: 1px; width: 8%; text-align: center;"><?php echo round((($valueTypeservice['somme'] - $valueTypeservice['sommeAchat']) / $valueTypeservice['somme']) * 100) ?> %</td>
							<td style="padding: 5px; padding-top: 1px; padding-bottom: 1px; width: 14.4%; text-align: center;"><?php echo html_entity_decode(decodeCaractere($valueTypeservice['commentaire'])); ?> </td>
						</tr>
						<?php
										$listService = Connexion::Connect()->query("
									SELECT DISTINCT(s.idService), s.service, d.quantite, d.prixVente
					  ...
					  ");
							...
							<tr>
								...
								<td style="padding: 5px; width: 9%; text-align: right;">

								</td>
								<td style="padding: 5px; width: 8.8%; font-weight: bold; text-align: center;">&nbsp;</td>
				...
				<td style="width: 100%;">
					<table style="width: 100%;" cellpadding="0" cellspacing="0">
						<tr style="font-weight: bold;">
							<td style="padding: 5px; width: 42%;">
								Montant HT
							</td>
							<td style="padding: 5px; width: 18%; text-align: right;">
								<?php echo number_format($value['montantDevis'], 0, ',', ' ') ?> F
							</td>
							<td style="padding: 5px; width: 8.8%; font-weight: bold; text-align: right;"><?php echo number_format($value['montantDevisAchat'], 0, ',', ' ') ?> F</td>
							<td style="padding: 5px; width: 8.8%; text-align: right;"><?php echo number_format($value['montantDevis'] - $value['montantDevisAchat'], 0, ',', ' ') ?> F </td>
							<td style="padding: 5px; width: 8%; text-align: center;"></td>
							<td style="padding: 5px; width: 14.4%; text-align: center;"> </td>
						</tr>

						<tr>
							<td style="padding: 5px; width: 42%; font-style: italic;">
						...
						<tr style="">
							<td style="font-weight: bold; background-color: #481511; color: #fff; padding: 5px; width: 42%;">
								TOTAL HT
							</td>
							<td style="font-weight: bold; background-color: #481511; color: #fff; padding: 5px; width: 18%; text-align: right;">
								<?php echo number_format(($value['montantDevis'] + (($value['montantDevis'] * $value['commissionProduction']) / 100)), 0, ',', ' ') ?> F
							</td>
							<td style="padding: 5px; width: 8.8%; text-align: right;">MB HT = </td>
							<td style="padding: 5px; width: 8.8%; text-align: right;"><?php echo number_format(($value['montantDevis'] - $value['montantDevisAchat']) + (($value['montantDevis'] * $value['commissionProduction']) / 100), 0, ',', ' ') ?> F </td>
							<td style="padding: 5px; width: 8%; text-align: center;"></td>
							<td style="padding: 5px; width: 14.4%; text-align: center;"> </td>
						</tr>
					</table>
					<table style="width: 100%;" cellpadding="0" cellspacing="0">
						<tr style="">
							<td style="background-color: #26c0c9; color: #ffffff; padding: 5px; width: 60%;">
								Taxe municipale (0F) en sus
							</td>
							<td style="padding: 5px; width: 8.8%; font-weight: bold;"> &nbsp;</td>
							<td style="padding: 5px; width: 8.8%; text-align: right; font-weight: bold;"><?php echo round(((($value['montantDevis'] - $value['montantDevisAchat']) + (($value['montantDevis'] * $value['commissionProduction']) / 100)) / ($value['montantDevis'] + (($value['montantDevis'] * $value['commissionProduction']) / 100))) * 100) ?> % </td>
							<td style="padding: 5px; width: 8%; text-align: center;"></td>
							<td style="padding: 5px; width: 14.4%; text-align: center;"> </td>
						</tr>
					</table>
					<table style="width: 90%;" cellpadding="0" cellspacing="0">
						<tr>
							<td style="padding: 5px; width: 48%; font-style: italic;">
								TVA 18% sur TOTAL HT en sus
							</td>
							<td style="padding: 5px; width: 18%; text-align: right;">
								<?php /*echo number_format(($value['montantDevis'] * (0.18)), 0, ',', ' ') */ ?>
								<?php if ($typetaxe != 1){ ?>
								<?php  echo number_format((($value['montantDevis'] + ((($value['montantDevis'] * $value['commissionProduction']) / 100))) * (0.18)), 0, ',', ' ') ?> F
								<?php } ?>
							</td>
							<td style="padding: 5px; width: 8.8%; font-weight: bold;"> &nbsp;</td>
							<td style="padding: 5px; width: 8.8%; text-align: center;"> </td>
						...
						<?php if ($typetaxe != 1){ ?>
						<tr style="">
							<td td style="font-weight: bold; background-color: #481511; color: #fff; padding: 5px; width: 48%;">
								TOTAL GENERAL
							</td>
							<td style="font-weight: bold; background-color: #481511; color: #fff; padding: 5px; width: 18%; text-align: right;">
								<!-- <?php echo number_format($value['montantDevis'] + (((($value['montantDevis'] * $value['commissionProduction']) / 100)) * (0.18)) + ($value['montantDevis'] * $value['taxeMunicipale']) / 100, 0, ',', ' ') ?> F -->
								<?php echo number_format(($value['montantDevis'] + (($value['commissionProduction'] * $value['montantDevis']) / 100)) + (($value['montantDevis'] + ((($value['montantDevis'] * $value['commissionProduction']) / 100))) * (0.18)), 0, ',', ' ') ?> F
		...
		<table class="addPadding" cellpadding="0" cellspacing="0">
			<tr>
				<td style="width: 100%;">
					<?php echo html_entity_decode(substr(($value['commentaire']), 17, -18)) ?>
				</td>
			</tr>
...
// $idDossier =1;
// $idRapport = rand();
@unlink("devis/FeuilleMarge_" . $idDevis . ".pdf");
$fact->Output("devis/FeuilleMarge_" . $idDevis . ".pdf", 'F');
// $fact->Output("devis/FeuilleMarge_".$idDevis.".pdf", 'O');
echo (int) $idDevis;
