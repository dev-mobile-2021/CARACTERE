...
if (isset($_POST["export_excel"])) {
  ...
  if($months){
    ...
    $requete = Connexion::Connect()->prepare("SELECT typeservices, SUM(montantDevis) 'total' ,
            ...
            IF(MONTH(dateAjout)=8,SUM(montantDevis),'0') 'aout' ,
             IF(MONTH(dateAjout)=9,SUM(montantDevis),'0') 'septembre' ,
              ...
              IF(MONTH(dateAjout)=11,SUM(montantDevis),'0') 'novembre' ,
               ...
               FROM vdevis2 WHERE YEAR(dateAjout) = \"$year\"
    ...
    $sommeMontant = $montantTotal;
      ...
      if (count($devis) > 0) {
        $output .= '
            ...
            <b style="text-align:center">STATISTIQUES MENSUELLES PRODUITS</b>
        ...
        header("Content-Disposition: attachment; filename=Mensuelproduit.xls");
        echo $output;
      }
