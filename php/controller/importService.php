...
if ($_FILES["import_excel"]["name"] != '') {
    ...
    if (in_array($file_extension, $allowed_extension)) {
        ...
        $sql = " INSERT INTO `typeservice` (`referenceTypeservice`, `typeService`,  `idFamille`, `description`) VALUES( :referenceTypeservice,  :typeService,  :idFamille, :description, )";
        ...
        foreach ($data  as $key => $value) {
            ...
            if ($key > 0) {
                    ...
                    $stmt->execute(array('referenceTypeservice' => $value[0], 'typeService' => $value[1], 'idFamille' => $value[2], 'description' => $value[3]));
