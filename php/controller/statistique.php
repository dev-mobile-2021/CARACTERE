<?php
    ...
    if(isset($_GET['changerEtat'])){
        ...
        if(isset($opt)){
            ...
            $option = $opt[0];
            if($option == "ajouter"){
                include('php/view/statistique/ajouter.php');
               ...
               require_once('php/classe/classeStatistique.php');
                ...
                include('php/view/statistique/liste.php');
            }
            else if($option=="details"){
                include('php/view/statistique/details.php');
            }else if($option=="liste"){
                include('php/view/statistique/liste.php');
            }
            else if($option=="analyse"){
                include('php/view/statistique/analyse.php');
            
            }else if($option=="cumulclient"){
                        include('php/view/statistique/cumulclient.php');
            }else if($option=="cumulproduit"){
                        include('php/view/statistique/cumulproduit.php');
            }else if($option=="mensuelproduit"){
                        include('php/view/statistique/mensuelproduit.php');
            }else if($option=="mensuelclient"){
                        include('php/view/statistique/mensuelclient.php');
            }else if($option=="tableaumarge"){
                        include('php/view/statistique/tableaumarge.php');
            }
        }
        else{
