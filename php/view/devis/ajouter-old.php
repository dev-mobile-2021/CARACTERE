                  ...
                  <div class="col-md-12" style="padding-top: 20px; padding-bottom: 20px; border:1px solid #000;">
                    <div class="row" style="margin-left: 0px; margin-right: 0px;">
                      <div class="col-md-12">
                        ...
                        <div class="form-group">
                          <label for="commentaireTypeservice">Fournisseur </label>
                          <select  class="form-control select2" required="" name="commentaireTypeservice">
                            ...
                            if (!empty($list)) {
                              foreach ($list as $value) {
                                echo '<option value="' . $value['idFournisseur'] . '">' . $value['prenomFournisseur'] . " " . $value['nomFournisseur'] . '</option>';
                              }
                            }
                            ?>
                          </select>
...
<script type="text/javascript">
  ...
  function saveDetails() {
    if ($("#idService").val() == null
     /*|| $("#prixAchat").val().length === 0 || $("#prixVente").val().length === 0 || $("#quantite").val().length === 0*/ ) {
      // alert("remplir tout");
      swal({
        title: "Erreur",
      ...
      var texteSousService = $("#idService :selected").text();
  ...
  function saveDetailsUpdate() {
    ...
    if ($("#monFormUpdateLine #idServiceMod").val() == null /*|| $("#prixAchat").val().length === 0 || $("#prixVente").val().length === 0 || $("#quantite").val().length === 0*/ ) {
      ...
      $("#sousServicesAjoutes").append('<div onclick="updateLine(' + idServiceMod + ')" data-toggle="tooltip" title="Cliquez pour modifier" class="row ligneSousService" id="id' + idServiceMod + '" style="margin-left: 0px; margin-right: 0px; margin: 5px 0px 5px 0px;"><div class="col-md-10" style="padding-right: 0px;"><div class="col-md-3" style="padding-left: 0px;">' + texteSousService + '</div><div class="col-md-3" style="padding-left: 0px; text-align:right;">' + prixAchatTexte + ' F</div><div class="col-md-3" style="padding-left: 0px; text-align:right;">' + prixVenteTexte + ' F</div><div class="col-md-3" style="padding-left: 0px; text-align:right;">' + quantiteTexte + '</div></div><div class="col-md-2" style="padding-right: 0px;"><div class="col-md-12 montantSousService" data-value="' + parseInt(prixVente) * parseInt(quantite) + '" style="padding-left: 0px; text-align:right;">' + totalLigne + ' F</div></div></div>');
      $(".ligneSousService").tooltip();
      //Desactivation du sous service dans la liste
  ...
  function sendAll() {
    ...
    if (((totalService == totalSousService) && (totalService != 0 && totalSousService != 0)) || (totalSousService == 0 && totalService != 0) || (totalSousService != 0 && totalService == 0)) {
      var idRubrique = $('#idRubrique').val();
      var idFamille = $('#idFamille').val();
      var idTypeservice = $('#idTypeservice').val();

      var texteTypeService = $("#idTypeservice :selected").text();
      var texteRubrique = $("#idRubrique :selected").text();
          ...
          if (parseInt(msgvals[0]) == 1) {
            ...
            if ($('#Rubrique' + idRubrique).length) {
              ...
              $("#Famille" + idFamille).append(
                ...
                '<p class="typeServiceUtilise' + idFamille + '" data-value="' + idTypeservice + '"><strong>' + texteTypeService + '</strong><strong class="classTotalService" data-value="' + totalServiceAfficheValeur + '" style="float: right; padding-right: 3px;">' + totalServiceAffiche + ' F</strong></p>' +
                '<p>' +
                sousServicesAffiche +
                '</p>' +
                '</div>'
