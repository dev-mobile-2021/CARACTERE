...
<div class="content-wrapper">
  <section class="content">
    <section class="content-header">
      <h1>
        Facture
        <small>Liste des devis &agrave; facturer (Avec BC)</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-home"></i>Accueil</a></li>
        <li><a href="#">Facture</a></li>
        <li class="active">Liste des devis &agrave; facturer (Avec BC)</li>
      </ol>
    </section>
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box  box-primary">
            <div class="box-header">
              <h3 class="box-title">Liste des devis &agrave; facturer (Avec BC)</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            <form action="php/controller/exportafacturerbc.php" method="post">
                    ...
                    <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example1_info">
                      ...
                      <tbody>
                        <?php  
                          ...
                          $Devis= new Devis();
                          $list = $Devis->listDevisFacturation(LIVRE, "AND idDevis IN (SELECT idDevis FROM devisbc WHERE etat = 1)");
                        ...
                        ?>
                          <tr id="<?php echo $value['idDevis'] ?>">
                            ...
                            <td style="text-align:right;"><?php echo number_format($value['montantDevis'], 0, ',', ' ') ?></td>
...
<script type="text/javascript">
  ...
  function facturer(idDevis){
    $("#addFacturer #idDevis").attr("value", idDevis);
    $("#addFacturer").modal("show");
  }
...
<div class="modal fade" id="addFacturer">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form id="monFormFacturer">
        <div class="modal-body">
          <div class="row">
            <div class="col-md-12">
              <div class="col-md-12" style="padding-left: 0px;">
                <div class="form-group">
                  <label for="destinataire">&Agrave; l'attention de : </label>
              ...
              <div class="col-md-12" style="padding-left: 0px;">
                <div class="form-group">
                  ...
                  <div class="input-group date">
                    ...
                    <input type="text" required="" class="form-control pull-right datepicker" name="dateFacture">
                  </div>
                  <!-- /.input group -->
                </div>
                <!-- <div class="form-group">
              ...
              <div class="col-md-12" style="padding-left: 0px;">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="accompte" name="accompte" placeholder="Entrer l'acompte en %">
                </div>
              </div>
            </div>     
          </div>
