<div class="content-wrapper">
  <section class="content">
    <section class="content-header">
      <h1>
        Facture
        <small>Liste des devis &agrave; facturer (Attente BC)</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-home"></i>Accueil</a></li>
        <li><a href="#">Facture</a></li>
        <li class="active">Liste des devis &agrave; facturer (Attente BC)</li>
      </ol>
    </section>
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box  box-primary">
            <div class="box-header">
              <h3 class="box-title">Liste des devis &agrave; facturer (Attente BC)</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            <form action="php/controller/exportafacturersansbc.php" method="post">
                    ...
                    <table id="example1" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example1_info">
                      ...
                      <tbody>
                        <?php  
                          ...
                          $Devis= new Devis();
                          $list = $Devis->listDevisFacturation(LIVRE, "AND idDevis NOT IN (SELECT idDevis FROM devisbc WHERE etat = 1)");
