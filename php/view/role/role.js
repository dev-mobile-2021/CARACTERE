$(function(){
    $('#monForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(msg){
                if(parseInt(msg)==1){
                    swal({ title: "Effectué !", text: "Le role a &eacute;t&eacute; ajout&eacute; avec succ&egrave;s", imageUrl: 'dist/img/icones/success.png', html: true});
                    $(document).click(function(){
                        window.location.href = "role_liste";
                    });
    ...
    $('#monFormMod').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(msg){
                if(parseInt(msg)==1){
                    swal({ title: "Effectué !", text: "Le role a &eacute;t&eacute; modifi&eacute; avec succ&egrave;s", imageUrl: 'dist/img/icones/success.png', html: true});
                    $(document).click(function(){
                        window.location.href = "role_liste";
                    });
                }else if(parseInt(msg)==2){ 
