$(function(){
    $('#monForm').on('submit', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "php/controller/rubrique.php", //process to mail
            data: $(this).serialize(),
            success: function(msg){
                if(parseInt(msg)==1){
                    swal({ title: "Effectué !", text: "La rubrique a &eacute;t&eacute; ajout&eacute;e avec succ&egrave;s", imageUrl: 'dist/img/icones/success.png', html: true});
                    $(document).click(function(){
                        window.location.href = "rubrique_liste";
                    });
    ...
    $('#monFormMod').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(msg){
                if(parseInt(msg)==1){
                    swal({ title: "Effectué !", text: "La rubrique a &eacute;t&eacute; modifi&eacute;e avec succ&egrave;s", imageUrl: 'dist/img/icones/success.png', html: true});
                    $(document).click(function(){
                        window.location.href = "rubrique_liste";
                    });
                }else if(parseInt(msg)==2){ 
