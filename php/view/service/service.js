$(function(){
    $('#monForm').on('submit', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "php/controller/service.php", //process to mail
            data: $(this).serialize(),
            success: function(msg){
                if(parseInt(msg)==1){
                    ...
                    $(document).click(function(){
                        window.location.href = "service_liste";
                    });
                }else if(parseInt(msg)==2){ 
                    swal({ title: "Erreur", text: "Ce descriptif existe d&eacute;j&agrave; ", imageUrl: 'dist/img/icones/error.png', html: true});
                }else{ 
    ...
    $('#monFormMod').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(msg){
                if(parseInt(msg)==1){
                    swal({ title: "Effectué !", text: "Le descriptif a &eacute;t&eacute; modifi&eacute; avec succ&egrave;s", imageUrl: 'dist/img/icones/success.png', html: true});
                    $(document).click(function(){
                        window.location.href = "service_liste";
                    });
                }else if(parseInt(msg)==2){ 
