$(function () {
    $('#monForm').on('submit', function (e) {
        ...
        if ($("#password").val() == $("#password2").val()) {
            $.ajax({
                type: "POST",
                url: "php/controller/statistique.php", //process to mail
                data: formData,
                ...
                success: function (msg) {
                    if (parseInt(msg) == 1) {
                        swal({ title: "Effectué !", text: "Le client a &eacute;t&eacute; ajout&eacute; avec succ&egrave;s", imageUrl: 'dist/img/icones/success.png', html: true });
    ...
    $('#monFormMod').on('submit', function (e) {
        ...
        $.ajax({
            type: "POST",
            url: "php/controller/client.php?img=" + $("#photoClientMod").attr("value"), //process to mail
            data: formData,
            mimeType: "multipart/form-data",
            contentType: false,
            cache: false,
            ...
            success: function (msg) {
                if (parseInt(msg) == 1) {
                    swal({ title: "Effectué !", text: "Le client a &eacute;t&eacute; modifi&eacute; avec succ&egrave;s", imageUrl: 'dist/img/icones/success.png', html: true });
                    $(document).click(function () {
                        location.reload();
                    });
                } else {
...
//                     swal({
//                         title: "Effectué !",
//                         text: "Le client a &eacute;t&eacute; ajout&eacute; avec succ&egrave;s",
