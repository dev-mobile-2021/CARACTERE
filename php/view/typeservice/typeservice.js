$(function(){
    $('#monForm').on('submit', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "php/controller/typeservice.php", //process to mail
            data: $(this).serialize(),
            success: function(msg){
                if(parseInt(msg)==1){
                    ...
                    $(document).click(function(){
                        window.location.href = "typeservice_liste";
                    });
    ...
    $('#monFormMod').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(msg){
                if(parseInt(msg)==1){
                    swal({ title: "Effectué !", text: "Le service a &eacute;t&eacute; modifi&eacute; avec succ&egrave;s", imageUrl: 'dist/img/icones/success.png', html: true});
                    $(document).click(function(){
                        window.location.href = "typeservice_liste";
                    });
                }else if(parseInt(msg)==2){ 
